...
{% quote name="Google Advanced Protection Program" link="https://support.google.com/accounts/answer/7519408" %}
...
{% quote name="Daniel Micay, lead developer of GrapheneOS" link="https://grapheneos.org/usage#web-browsing" %}
...
{% quote name="Madaidan, Whonix security researcher" link="https://madaidans-insecurities.github.io/security-privacy-advice.html#browser" %}
...
{% quote name="Madaidan" link="https://madaidans-insecurities.github.io/firefox-chromium.html#site-isolation" %}
...
{% quote name="Patrick Brady, Google engineer" link="https://en.wikipedia.org/wiki/Android_(operating_system)#Linux_kernel" %}
Android is not Linux
{% /quote %}

{% quote name="Ars Technica" link="https://arstechnica.com/gadgets/2009/02/an-introduction-to-google-android-for-developers/" %}
...
{% quote name="Tommy, PrivSec.dev" link="https://privsec.dev/os/android-tips/#recommended-phones" %}
...
{% quote name="Google Security Blog" link="https://security.googleblog.com/2018/10/building-titan-better-security-through.html" %}
