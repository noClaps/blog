...
When you add any post, it should be added to the `links.json` file in the homepage. The format for this is defined in the [Links](/sites/homepage/links) documentation. This will allow it to be searched in the [homepage](https://zerolimits.dev) search.
