...
1. You type in a URL into your search bar, like https://zerolimits.dev.
2. This is then sent to your domain name service (DNS), which then converts the URL into an IP address.
3. This IP address, along with your IP address, is then sent to your internet service provider (ISP), which then sends it to the correct server for https://zerolimits.dev.
