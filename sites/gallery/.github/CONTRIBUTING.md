...
#### Improvement
This type of issue is meant for you to provide ideas for features to add to the website, and improvements in general. You can suggest almost anything you want, just make sure that it's actually possible while using Astro. However, I have a few rules:
