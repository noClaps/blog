...
{% quote name="Yen Chih-Tui (531-591), scholar-official, circa 589" %}
...
{% quote name="Arab traveller to China, 851 AD" %}
...
{% quote name="Barry Kudrowitz, associate professor and director of product design at the University of Minnesota" %}
...
- Hygiene sticks were mentioned in Buddhist koans.
  ...
  {% quote name="An excerpt from a Buddhist koan" %}
