...
Google had its #link("https://about.google/our-story/")[humble beginnings] in 1995 as a research project by Stanford University students Larry Page, Sergey Brin, and Scott Hassan. While Hassan left before the company was officially founded, the other two remained, and went on to become owners of one of the #link("https://www.gobankingrates.com/money/business/how-much-is-google-worth/")[largest companies] in the world.

Now, the company that started out as a simple search engine controls the daily lives of millions of people around the world, with their #link("https://sg.oberlo.com/statistics/search-engine-market-share")[largest product] being Google Search. It's so popular that "Googling" has become #link("https://www.merriam-webster.com/dictionary/google")[synonymous] with searching the web. Other than the search engine, Google's other products are also widely used, such as #link("https://enlyft.com/tech/products/google-drive")[Google Drive], #link("https://techjury.net/blog/gmail-statistics/")[Gmail], #link("https://webtribunal.net/blog/google-map-statistics/")[Google Maps], etc. However, Google's most popular products are #link("https://gs.statcounter.com/os-market-share")[Android] and #link("https://gs.statcounter.com/browser-market-share")[Chrome].

= Billionaires

#link("https://en.wikipedia.org/wiki/Alphabet_Inc.")[Alphabet] is the current parent company of Google and its former subsidiaries, and fills the position that Google used to fill until #link("https://techcrunch.com/2015/10/02/google-becomes-alphabet/")[October 2015]. Alphabet was the #link("https://en.wikipedia.org/wiki/List_of_largest_technology_companies_by_revenue#2021_list")[3#super[rd]-largest] tech company (by revenue) in the world in 2021, only behind Apple and Samsung, beating out other huge companies like Microsoft and Facebook/Meta. That's impressive, but where do they get so much money, when most of Google's products are free for people to use?

== Subsidiaries

Alphabet and Google own #link("https://www.kamilfranek.com/what-companies-alphabet-google-owns/")[a _lot_ of companies]. Here's a small list of companies that they own:
...
In order to display ads on your website, you set up certain areas where ads can be displayed, which I'll call ad spots. You go to #link("https://en.wikipedia.org/wiki/Google_AdSense")[Google Adsense], and you tell them that you want to display ads on your website. Google will then generate some code, which you can copy onto your website, and _voilà_! You now have ads shown on your website.
...
All of this is automated, obviously. It's a bunch of bots bidding against other bots, and an #link("https://searchengineland.com/new-adwords-ad-ranking-formula-what-does-it-mean-174946")[algorithm] to select the most optimal advertisement to show to users.
...
Although Google doesn't sell your data, this doesn't mean they don't collect it. They collect #link("https://policies.google.com/privacy?hl=en-US#infocollect")[a _lot_ of data], such as your browsing history, app usage, contacts, photos, name, search data, and so much more.

If you trust Google with this data, then great! Google has implemented #link("https://policies.google.com/privacy?hl=en-US#infosecurity")[extensive security measures] to keep your personal information safe from anyone else, malicious or otherwise. #link("https://en.wikipedia.org/wiki/List_of_data_breaches")[Nothing's 100% secure], but Google is definitely one of the closest.

However, if you don't trust Google, then this can be a huge issue. They hold a immense amount of data on everyone that is currently using and has previously used their services. And I don't just mean those people using Google services like Gmail, Google Docs, Drive, etc., that list also includes anyone who has filled out a #link("https://www.makeuseof.com/tag/google-recaptcha-captures-private-information/")[reCAPTCHA], or has used a website or app that uses #link("https://matomo.org/blog/2022/06/google-analytics-privacy-issues/")[Google Analytics]. While it is anonymised and encrypted, #link("https://blog.malwarebytes.com/threat-analysis/2018/03/encryption-101-how-to-break-encryption/")[encryption can be broken] and #link("https://techcrunch.com/2019/07/24/researchers-spotlight-the-lie-of-anonymous-data/")[information can be de-anonymised] with relative ease. This is a huge privacy issue, and #link("https://www.zdnet.com/article/gdpr-google-hit-with-eur50-million-fine-by-french-data-protection-watchdog/")[Google's paid the price for it]. However, at this point, companies are #link("https://www.theverge.com/2019/4/24/18514805/facebook-q1-2019-earnings-ftc-record-fine-privacy-violations-3-billion")[setting aside huge amounts of money] specifically to cover fines imposed on them, so that they don't have to change their ways.

== Monopoly

If you think back to 2001, you may recall #link("https://en.wikipedia.org/wiki/United_States_v._Microsoft_Corp.")[_United States v. Microsoft Corp._], which was an antitrust law case against Microsoft for illegally maintaining a monopoly. At the time, Microsoft's Internet Explorer had an approximately 90% share in the global web browser market, eventually peaking at 96% in 2002.

Today, Microsoft no longer holds that position in browsers. Chrome is now the leader in browsers, with a #link("https://gs.statcounter.com/browser-market-share")[65% market share] (as of June 2022). Chrome is built on the open source #link("https://www.chromium.org/Home/")[Chromium] project, which is mainly developed by Google. Other companies also use Chromium as their base to build their own browsers, such as #link("https://en.wikipedia.org/wiki/Brave_(web_browser)")[Brave], #link("https://github.com/MicrosoftEdge/MSEdge/blob/14b03579d54acc5c294f846ad23f688a7eb8c124/README.md")[Microsoft Edge], #link("https://dev.opera.com/blog/a-first-peek-at-opera-15-for-computers/")[Opera], #link("https://en.wikipedia.org/wiki/Samsung_Internet")[Samsung Internet], #link("https://en.wikipedia.org/wiki/Vivaldi_(web_browser)")[Vivaldi], #link("https://en.wikipedia.org/wiki/Yandex_Browser")[Yandex Browser], etc. However, any changes Google makes to Chromium will generally be followed by these browsers. This gives Google a lot of power over the internet.

On top of that, Google Search has a #link("https://gs.statcounter.com/search-engine-market-share")[92% share] in the search engine market, with no one to contest them. While there are privacy-friendly options, like #link("https://duckduckgo.com/")[DuckDuckGo], #link("https://search.brave.com/")[Brave Search], #link("https://www.startpage.com/")[Startpage] and more, most people don't know they exist. And those that do, don't find the results good enough to use.
...
#quote(
  ...
  While Startpage has decent results (they use Google Search for their results), it doesn't work well if you're using Tor or a VPN, and they show their own ads which, while privacy-friendly, are annoying. Other than that, for most people, Startpage is the closest to Google you can get, privately. However, keep in mind that Startpage was #link("https://www.startpage.com/privacy-please/startpage-articles/startpage-and-privacy-one-group")[bought by System1], an #link("https://system1.com/what-we-do")[ad company]. While this #link("https://support.startpage.com/hc/en-us/articles/5194985436948-What-is-Startpage-s-relationship-with-Privacy-One-System1-and-what-does-this-mean-for-my-privacy-protections-")[doesn't seem to have much impact] on Startpage and its privacy, I think it's something to look out for in the future. After all, these kinds of deals have never ended well in the past, such as in the case of #link("https://techcrunch.com/2022/05/24/ddg-microsoft-tracking-blocking-limit/")[DuckDuckGo and Microsoft]. DuckDuckGo eventually did #link("https://www.theregister.com/2022/08/06/in_brief_security/")[block those trackers], but it was enough that people stopped trusting them.

  I do recommend Brave Search, however. They use their own search index for results, and it's worked flawlessly for ~95% of my searches. If you like Brave Search, you can set it as the #link("https://search.brave.com/default")[default search engine] in your browser.

  *I am not affiliated with any of these companies.* This recommendation is purely based on personal experience.
]

Google also makes Android, which is used by #link("https://gs.statcounter.com/os-market-share/mobile")[over 70% of all mobile devices], most of which are also using Google Play Services and Google's apps.

Google has tried to use this monopolistic position to control the internet, and have been #link("https://www.wired.com/story/google-antitrust-lawsuits-explainer/")[sued for it], multiple times.
...
Google has been very #link("https://opensource.google/projects")[involved] with the open source community, far more than any other companies of Big Tech. From #link("https://source.android.com/")[Android], #link("https://chromium.googlesource.com/chromium/src.git")[Chromium], #link("https://github.com/angular")[Angular], #link("https://github.com/dart-lang")[Dart], #link("https://github.com/flutter")[Flutter], #link("https://go.googlesource.com/go")[Golang], #link("https://github.com/kubernetes")[Kubernetes], and more, Google has always been very supportive of the open source philosophy. Even their upcoming OS, #link("https://fuchsia.dev/")[Fuchsia], is #link("https://fuchsia.dev/fuchsia-src/get-started/get_fuchsia_source")[open source].

This shows that Google is inclusive of the developer community as a whole, not just their own employees. Google open sourcing their work is what has allowed us to get amazing projects such as #link("https://grapheneos.org/")[GrapheneOS], #link("https://brave.com/")[Brave Browser], #link("https://www.electronjs.org/")[Electron], #link("https://scully.io/")[Scully], #link("https://gohugo.io")[Hugo], and more. Open source has plenty of other benefits too, in terms of privacy and trust, as I've outlined in my #link("/posts/intro-psa#open-source-everything")[Intro to Privacy, Security and Anonymity post].

== Security

Google is one of the world leaders in software and hardware security, from #link("https://en.wikipedia.org/wiki/Project_Zero")[Project Zero], Google's team of security researchers, to paying #link("https://venturebeat.com/security/google-has-paid-security-researchers-over-15-million-for-bug-bounties-3-4-million-in-2018-alone/")[millions of dollars for bug bounties]. Google has #link("https://safety.google/security/built-in-protection/")[encryption in transit] for all of your data, so that no one else can access it. They also have the #link("https://support.google.com/accounts/answer/7519408")[Advanced Protection Program] for those needing extra security.

#quote(
  title: [Google Advanced Protection Program],
  href: "https://support.google.com/accounts/answer/7519408",
)[
...
#quote(
  title: [Daniel Micay, lead developer of GrapheneOS],
  href: "https://grapheneos.org/usage#web-browsing",
)[
...
#quote(
  title: [Madaidan, Whonix security researcher],
  href: "https://madaidans-insecurities.github.io/security-privacy-advice.html#browser",
)[
...
If a lot of that made no sense to you, don't worry, you're not alone. I tried to pick out the easiest-to-understand parts, but it takes years and years of research and experience to get to the level of understanding these people have reached. However, their main point is clear: Chromium is _really_ secure. The Chromium team has a #link("https://www.chromium.org/Home/chromium-security/")[whole page about their security] in their documentation, if you want to read more. It's a little easier to read than the technical stuff the researchers above were talking about.

From what I've understood, one of Chromium's best security features is #link("https://en.wikipedia.org/wiki/Sandbox_(computer_security)")[sandboxing], which is a way to separate processes from one another so that they can't access each other, at least without your permission. Firefox has its own sandboxing solution, called #link("https://wiki.mozilla.org/Project_Fission")[Project Fission], which rolled out in Firefox 95. However, it's not as strong as Chromium's site isolation (this is a type of sandboxing).

#quote(
  title: [Madaidan],
  href: "https://madaidans-insecurities.github.io/firefox-chromium.html#site-isolation",
)[
  Firefox fully rolled out their Fission project in #link("https://www.mozilla.org/en-US/firefox/95.0/releasenotes/")[Firefox 95]. However, Fission in its current state is not as mature as Chromium's site isolation, and it will take many more years for it to reach that point. Fission still suffers from all the security issues of the baseline content process sandbox, as documented below, and it is not a panacea for all sandboxing issues. However, more specific to Fission itself, there are #link("https://bugzilla.mozilla.org/show_bug.cgi?id=1505832")[numerous] #link("https://bugzilla.mozilla.org/show_bug.cgi?id=1484019")[cross-site] #link("https://bugzilla.mozilla.org/show_bug.cgi?id=1707955")[leaks], allowing a compromised content process to access the data of another and bypass site isolation.
]
...
#quote(
  title: [Patrick Brady, Google engineer],
  href: "https://en.wikipedia.org/wiki/Android_(operating_system)#Linux_kernel",
)[
...
#quote(
  title: [Ars Technica],
  href: "https://arstechnica.com/gadgets/2009/02/an-introduction-to-google-android-for-developers/",
)[
...
#link("https://source.android.com/security")[Android's security model] is often praised as #link("https://madaidans-insecurities.github.io/android.html")[one of the strongest], and that can be further #link("https://grapheneos.org/features")[improved by GrapheneOS] on a Google Pixel device.

On the ChromeOS side of things, a similar story can be seen. Chromebooks take #link("https://support.google.com/chromebook/answer/3438631")[extensive measures] to ensure your security, even on those not made by Google.
...
This is just a few of the security features that Google has implemented into their operating systems. Their upcoming OS, Fuchsia, should have even stronger security, with its custom-made #link("https://fuchsia.dev/fuchsia-src/concepts/kernel")[Zircon kernel] and all of the knowledge Google has attained over the years.
...
#quote(
  title: [Tommy, PrivSec.dev],
  href: "https://privsec.dev/os/android-tips/#recommended-phones",
)[
  Google Pixel phones are the only devices I would recommend for purchase. Pixel phones have stronger hardware security than any other Android devices currently on the market, due to proper AVB support for third-party operating systems and Google’s custom #link("https://security.googleblog.com/2021/10/pixel-6-setting-new-standard-for-mobile.html")[Titan] security chips acting as the Secure Element.
]

This starts with the #link("https://security.googleblog.com/2018/10/building-titan-better-security-through.html")[Titan M] series of security chips that they've used in their devices starting from the Pixel 3. The chip is custom-built by Google, and gives the Pixel line a lot of security advantages over the competition, at least on the Android side.

#quote(
  title: [Google Security Blog],
  href: "https://security.googleblog.com/2018/10/building-titan-better-security-through.html",
)[
...
This only got better when Google introduced their #link("https://security.googleblog.com/2021/10/pixel-6-setting-new-standard-for-mobile.html")[custom Tensor processor] in the Pixel 6, since they were then able to secure not only the security chip, but also the processor. This was a significant step forward for Pixel security, and has since made the Pixel 6 line one of, if not _the_ most, secure phones to use in the world. Additionally, Google is now able to provide software updates for a longer amount of time: #link("https://support.google.com/nexus/answer/4457705?hl=en#zippy=%2Cpixel-later-pixel-phones")[5 years] instead of 3, which means your phone can be even more secure, for longer. This is one of the main reasons that privacy- and security-focused projects like GrapheneOS #link("https://grapheneos.org/faq#recommended-devices")[only recommend] and support the Pixel line, at least for now.
...
#super[P.S. #link("https://killedbygoogle.com/")[Google, please stop killing off all of your products].]

= Additional Sources

#link("https://en.wikipedia.org/wiki/Google_AdSense#How_it_works")[How it works - Google AdSense - Wikipedia]

#link("https://safety.google/")[Google Safety Center]

#link("https://security.googleblog.com/")[Google Security Blog]
