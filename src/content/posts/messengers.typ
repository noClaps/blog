...
As I mentioned in the #link("/posts/intro-psa")[Intro post], privacy, security and anonymity are different things, and that's gonna be a little clearer in this post as we compare different messengers.
...
One of the #link("https://en.wikipedia.org/wiki/Text_messaging#Worldwide_use")[most popular forms of messenger], SMS, has #link("https://en.wikipedia.org/wiki/Instant_messaging#Encryption")[no encryption]. This means that governments, companies, hackers, and anyone with basic tools can #link("https://theconversation.com/how-hackers-can-use-message-mirroring-apps-to-see-all-your-sms-texts-and-bypass-2fa-security-165817")[see all of your messages]. While this might not be worrying, because "who even uses SMS?", #link("https://dataprot.net/statistics/two-factor-authentication-statistics/#two-factor-authentication-statistics")[many services use SMS as two-factor authentication (2FA)], including banks. This can allow any attackers to get your SMS 2FA codes and log in to your bank account, often without your knowledge.

It gets worse. There's a global telecom network known as #link("https://en.wikipedia.org/wiki/Signalling_System_No._7")[Signaling System 7 (SS7)], which turned out to have a #link("https://thehackernews.com/2014/12/hackers-can-read-your-private-sms-and.html")[really serious security hole] that allowed hackers to see and record calls, messages, location information, etc., of any person on the network. The thing is, nearly every telecom operator (Verizon, SingTel, Jio, Vodafone, etc.) around the world uses this protocol, and it's the reason you can call or SMS someone using a different provider. They weren't bothered about these flaws at all, their logic being, "You need lots of tech and money and stuff to exploit this, no one's gonna do it."

Until of course, #link("https://thehackernews.com/2017/05/ss7-vulnerability-bank-hacking.html")[someone did].

And that's why you *don't use SMS for anything* even remotely important. Use encrypted platforms like #link("#signal")[*Signal*], #link("#threema")[*Threema*], #link("#session")[*Session*], #link("#element-matrix")[*Element*] or any other end-to-end encrypted messenger.

== Twitter DMs and Reddit Chat

These are encrypted with your standard #link("/posts/intro-psa#the-green-lock")[HTTPS encryption] that comes with most websites and web-based apps. However, they don't have any dedicated encryption protocols, which is why they're in this section. This has lead to #link("https://arstechnica.com/information-technology/2020/07/hackers-obtained-twitter-dms-for-36-high-profile-account-holders/")[data leaking] from these platforms in the past.

I would recommend using other platforms like #link("#session")[*Session*], #link("#element-matrix")[*Element*] or #link("#threema")[*Threema*] instead, if you want to remain "anonymous" like you can on Twitter or Reddit.

= Encryption with trust

This is the section with the most well-known messaging apps. A lot of the trust comes down to the apps and/or servers being closed-source. Closed-source essentially means that a service, like WhatsApp, could _say_ that your messages aren't being looked at, but there's no real way to verify that, since you can't see the source code. The importance of open source was highlighted in my #link("/posts/intro-psa#open-source-everything")[Intro post].

== Discord

Discord is one of the most popular communication platforms, especially for large communities in the gaming world.

According to #link("https://discord.com/privacy")[Discord's privacy policy] (you know, that thing you agree to and never actually read?), #link("https://edit.tosdr.org/points/9070")[Discord can read all of your private messages]. While chats are encrypted in transit to Discord's servers and encrypted at rest on your devices (at least that's what they _say_), they're #link("https://www.techspot.com/article/2340-messaging-apps-encryption/#Discord")[stored unencrypted on Discord servers]. And the privacy toggles in the app settings mean basically nothing since they'll store the data anyway.

On top of that, Discord has outright #link("https://www.reddit.com/r/discordapp/comments/8nzb5d/why_is_discord_so_antiencryption/e001lr1/")[refused to implement end-to-end encryption], giving the same #link("/posts/intro-psa#why-is-encryption-important")["think of the children" argument] we discussed in the Intro post. #link("https://endsexualexploitation.org/articles/discord-is-a-haven-for-gamers-and-sexual-exploiters/")[And they can't even do that well!]

In 2020, #link("https://medium.com/tenable-techblog/lets-reverse-engineer-discord-1976773f4626")[some researchers reverse-engineered Discord] and found that:
...
I want to list some pros of Discord, just to balance the argument, but from a privacy and security perspective there don't seem to be many. Discord and its founder have had a #link("https://youtu.be/uvNkdAggUGU")[long history of shady practices], and I have no doubt that this is something that will continue for a long, long time.

In conclusion, not a good service, do not recommend. Use #link("#element-matrix")[*Element*] or #link("https://revolt.chat/")[*Revolt*] instead. If you _must_ use Discord, try #link("https://fosscord.com/")[*Fosscord*].

== WhatsApp

WhatsApp is the most used messaging app in the world, with over #link("https://blog.whatsapp.com/two-billion-users-connecting-the-world-privately")[2 billion users worldwide]. There are quite a few problems with WhatsApp, but it's a relatively safer platform than most of the options in this section.
...
#quote(
  title: [WhatsApp FAQ],
  href: "https://faq.whatsapp.com/general/security-and-privacy/end-to-end-encryption",
)[
...
#quote(
  title: [WhatsApp encryption whitepaper],
...
Along with that, WhatsApp backups to Google Drive are #link("https://www.eff.org/deeplinks/2021/09/whats-whatsapp-encrypted-backups")[not encrypted by default], and weren't encrypted at all for the longest time. This means your chats, images, videos, etc., were and might still be sitting unencrypted on Google's servers if you do happen to use Google Drive backup. If you happen to use WhatsApp with a Google account, be sure to go into the app's settings and check that you have encrypted backups enabled.

In addition to that, WhatsApp is owned by Meta/Facebook, one of the world's most privacy-invasive companies (just look at the #link("https://en.wikipedia.org/wiki/Lawsuits_involving_Meta_Platforms")[lawsuits they're involved in]), which doesn't help its case.

#link("https://medium.com/@m.muslimiblog/metadata-the-whatsapp-issue-affecting-you-2bf13e77d065")[WhatsApp also doesn't encrypt metadata], so Meta/Facebook can see all of that and use it to #link("https://en.wikipedia.org/wiki/Shadow_profile")[shadow-profile] you.
However, since WhatsApp (probably) does use end-to-end encryption, it's one of the less bad options on this list. Security-wise, I think WhatsApp is fine, most of its issues come from the privacy-invasive practices of Meta/Facebook. If you have *absolutely no other option*, or you trust Meta/Facebook for whatever reason, WhatsApp is mostly fine to use. However, I would recommend that you try out other platforms like #link("#signal")[*Signal*], #link("#threema")[*Threema*] or #link("#session")[*Session*] first, since they are much more private and secure than WhatsApp ever will be.
...
While the Telegram apps are #link("https://telegram.org/apps#source-code")[free and open source], the server isn't. This means that there is no way to verify what goes on in the servers, and most importantly, if the encryption actually takes place.

However, this is a relatively easily solved problem. You can use Telegram's secret chats, which is #link("https://telegram.org/faq#secret-chats")[end-to-end encrypted]. Also, Telegram calls and video calls are end-to-end encrypted too. However, secret chats are only for 1-on-1 chats, and so groups chats aren't end-to-end encrypted, whether public or private.

One of the main reasons that people choose to trust Telegram is their #link("https://telegram.org/faq#q-do-you-process-data-requests")[refusal to process data requests] from law enforcement, governments, etc.

In conclusion, I would not recommend this app unless you're willing to use *only secret chats*. Using normal or group chats in Telegram places a lot of trust in them, and trust can be dangerous. For most people, you're better off using #link("#signal")[*Signal*], #link("#threema")[*Threema*] or #link("#session")[*Session*] for small groups and 1-on-1 chats, and #link("#element-matrix")[*Element*] or #link("https://revolt.chat/")[*Revolt*] for the larger communities. Honestly, I believe even WhatsApp is better than using Telegram for most people, especially if you have group chats or aren't willing to set up secret chats for every contact you have.

== iMessage

iMessage is #link("https://www.apple.com/privacy/features/#imessage")[end-to-end encrypted] *only* if you're in blue-bubble mode. Green-bubble mode is SMS, which is completely unencrypted. You do have to trust that Apple really is encrypting your messages on your device, and they aren't able to see them without your knowledge or permission.

However, if you happen to have iCloud backups turned on, #link("https://www.howtogeek.com/710509/apples-imessage-is-secure...-unless-you-have-icloud-enabled/")[all of your messages are stored unencrypted on Apple's servers], freely available for Apple, the government, and anyone who Apple allows to look at them.

Sure, Apple's security is probably strong enough that most hackers won't be able to easily break in and see your messages. However, nothing is 100% secure, and there is a good chance that someone, with enough effort and determination and luck, will find a way in. Plus, why even let Apple see what you talk to your friends about? That should be something that stays between you and your friends. The simple solution to this is to #link("https://www.howtogeek.com/662872/how-to-disable-and-delete-icloud-backup-on-iphone-and-ipad/")[turn off iCloud backups], which you should do anyway since Apple #link("https://www.washingtonpost.com/technology/2019/05/28/its-middle-night-do-you-know-who-your-iphone-is-talking/")[isn't a] #link("https://www.eff.org/deeplinks/2021/08/apples-plan-think-different-about-encryption-opens-backdoor-your-private-life")[very] #link("https://www.reuters.com/article/us-apple-fbi-icloud-exclusive/exclusive-apple-dropped-plan-for-encrypting-backups-after-fbi-complained-sources-idUSKBN1ZK1CT?feedType=RSS&feedName=technologyNews")[trustworthy] #link("https://tosdr.org/en/service/158")[company]. If you need a cloud storage solution to replace iCloud, there's other better options I'll talk about in a future post, and you can find some on #link("https://www.privacyguides.org/cloud/")[Privacy Guides].

== Facebook Messenger and Instagram DMs

Facebook Messenger has an option to enable end-to-end encrypted #link("https://messengernews.fb.com/2021/08/13/messenger-updates-end-to-end-encrypted-chats-with-new-features/")[chats, voice and video calls] . Meta/Facebook are also testing #link("https://about.fb.com/news/2021/12/metas-approach-to-safer-private-messaging/")[end-to-end encryption in Instagram DMs]. However, since these aren't enabled by default, most people don't use them, because such is the power of defaults.

Again, use other platforms like #link("#signal")[*Signal*], #link("#threema")[*Threema*] or #link("#session")[*Session*], or at the very least enable end-to-end encryption where you can.
...
*Signal* is an open source messenger (and a #link("https://en.wikipedia.org/wiki/Signal_Foundation")[nonprofit foundation]) that uses their own #link("https://en.wikipedia.org/wiki/Signal_Protocol")[Signal Protocol] for end-to-end encryption. This protocol is used by a whole bunch of other messengers, like #link("https://signal.org/blog/whatsapp-complete/")[WhatsApp], #link("https://www.theverge.com/2020/11/19/21574451/android-rcs-encryption-message-end-to-end-beta")[Google's RCS Chat], #link("https://signal.org/blog/facebook-messenger/")[Facebook Messenger's Secret Conversations] and #link("https://signal.org/blog/skype-partnership/")[Skype's Private Conversations].

The Signal Protocol has been #link("https://en.wikipedia.org/wiki/Signal_Protocol#History")[audited] multiple times and has been found to be "cryptographically sound". It's used by some of the largest companies out there, so clearly they've done it right. Nothing is 100% secure, but the Signal Protocol is one of, if not *the* best, encryption protocol out there for messengers.
...
Signal has most of the features that people use in messaging apps, but it may not have *all* of the features that are available on other platforms yet. The developers are working hard on adding new features while maintaining your privacy and security, but since other platforms do not focus as much on user privacy and security, they can add features much more quickly than Signal can. If you want to suggest a feature, you can do so on their #link("https://community.signalusers.org/")[community] or by opening an issue on their #link("https://github.com/signalapp")[GitHub] in the respective repo. You can #link("https://signal.org/donate/")[donate to them here], or if you do it through the app, you can get a cool #link("https://support.signal.org/hc/en-us/articles/4408365318426-Sustainers-Boost-Badges")[Donor badge].

Signal also provides a #link("https://signal.org/bigbrother/")[list of government orders] that they receive, and what they're able to provide. Usually it's not much, since Signal collects little to no data/metadata.

One thing I have to add, Signal's server code is almost fully open source. This doesn't really matter since you can't see what's actually running on the servers anyway, and they won't be able to see your messages with end-to-end encryption. However, I say *almost* because there's a small part related to #link("https://signal.org/blog/keeping-spam-off-signal/")[spam blocking] that's closed source, since it's a bit difficult to stop spammers when they can see the code being used to block them. Personally, I don't have a problem with this, but I could understand it being an issue if you're looking for 100% transparency. However, one could argue that you can't really verify that the published server code is the same code actually running on the servers, so it wouldn't really matter either way.
...
Session uses their own #link("https://getsession.org/blog/session-protocol-technical-information")[Session Protocol] for end-to-end encryption. If you're worried about security as compared to Signal, Session has been #link("https://blog.quarkslab.com/resources/2021-05-04_audit-of-session-secure-messaging-application/20-08-Oxen-REP-v1.4.pdf")[audited] before. Also, since it's open source, you can look through the code and audit it yourself if you choose / are able to do so.

Session is also completely #link("https://en.wikipedia.org/wiki/Decentralization")[decentralised], which means that there's no central server as there is in almost every other messenger, including Signal. This makes Session censorship resistant, since the servers are in different countries and there's no way to track the messages. You can even #link("https://docs.oxen.io/about-the-oxen-blockchain/oxen-service-nodes")[host your own servers in the Oxen network], which Session runs on.
...
*Element* is an open source decentralised messenger that uses the *Matrix* protocol to work. You can use #link("https://matrix.org/clients/")[other Matrix clients] that may provide different UIs and features. I recommend Element since it provides the most complete Matrix experience, having been #link("https://element.io/#matrix-card")[founded by the team behind Matrix].

Matrix behaves similarly to email, since you have multiple "homeservers" that you can get your Matrix ID from. You can talk to people using other homeservers, just like you can do with email providers. You can also #link("https://matrix.org/docs/guides/installing-synapse")[host your own homeserver], which gives you much more control over what happens in it. (This is called #link("https://en.wikipedia.org/wiki/Decentralization")[decentralisation], by the way. And yes, email is technically decentralised.)
...
Matrix also has many unique features, but the one that intrigues me the most is #link("https://matrix.org/bridges/")[bridges]. Bridges are a feature that allows Matrix to interoperate with other services, like WhatsApp, Signal, Discord, iMessage, Telegram, and so many more services. However, bridging can reduce the effectiveness of the end-to-end encryption in the app you're bridging to, if they do support it, so keep that in mind if you do choose to set that up.

For the people who aren't technically advanced, but still want their own server and/or bridges, you can use #link("https://element.io/element-one")[Element One], #link("https://www.beeper.com/")[Beeper] or one of many other Matrix hosting providers out there willing to host it for you. They're mostly paid though.

Matrix isn't fully trustless since you have to trust the owner of your homeserver, but since private messages and group chats are end-to-end encrypted, the server owner can't see those messages anyway. Rooms and spaces can also optionally be end-to-end encrypted, though that's up to the room admin. The end-to-end encryption protocols used in Matrix are #link("https://gitlab.matrix.org/matrix-org/olm/blob/master/docs/olm.md")[Olm] and #link("https://gitlab.matrix.org/matrix-org/olm/blob/master/docs/megolm.md")[Megolm], based on the #link("https://signal.org/docs/specifications/doubleratchet/")[Double Ratchet Algorithm] popularised by Signal. They've been #link("https://matrix.org/blog/2016/11/21/matrixs-olm-end-to-end-encryption-security-assessment-released-and-implemented-cross-platform-on-riot-at-last")[audited].
...
*Threema* is probably one of the most feature-rich messengers that actually keeps your privacy and security in mind. They use #link("https://threema.ch/en/faq/why_secure")[end-to-end encryption] with the open source #link("https://nacl.cr.yp.to/")[NaCl] library. They have open source clients and have been #link("https://threema.ch/en/blog/posts/audit-2020-en")[audited], which makes them quite easy to recommend. Threema is also based in Switzerland, the country with some of the #link("https://en.wikipedia.org/wiki/Information_privacy_law#Switzerland")[strongest data] #link("https://datenrecht.ch/ndsg-en/")[protection laws] in the world, which, in my opinion, gives them an edge over the other messengers, most of which are #link("https://en.wikipedia.org/wiki/Information_privacy_law#United_States")[based in the US].
...
Threema offers #link("https://threema.ch/en/download")[clients] for Android, iOS, macOS, Windows, Linux (.deb/.rpm) as well as a web client, which is more than most of the messengers I've mentioned so far. However, you will need the mobile app first to use the desktop clients as you need to link them together first.

The biggest disadvantage of Threema that I can see is that #link("https://threema.ch/en/faq/why_not_free_of_charge")[their app is paid]. In a world of free apps like WhatsApp, Signal, Telegram, etc., a paid app like Threema doesn't stand much of a chance. To be fair to them, having a paid app means a clear business model as opposed to the shady data collection of most closed-source free apps.
