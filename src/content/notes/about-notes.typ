#let title = [What is this notes thing?]
#let date = datetime(year: 2023, month: 11, day: 24)

My main blog is for well-researched topics, and I try to be generally neutral with my takes, though obviously everyone has some or the other bias. Not all of the posts over on my main blog are completely neutral, #link("/posts/operating-systems")[the OSes one] is full of my opinions, for instance. However, I still wanted a place away from all that, just to post my own thoughts. So I guess that's what this is: a place for me to just write about whatever's on my mind, without the pressure of having to find sources and research everything first.
