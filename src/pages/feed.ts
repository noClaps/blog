...
const jsonEntries = items.map((item) => ({
...
export const jsonFeed = JSON.stringify({
...
export const atomFeed = html` <?xml version="1.0" encoding="utf-8"?>
...
const rssEntries = items.map((item) => ({
  author: "noClaps",
